  ...
  let s:guiaccent0 = "#444444"
  let s:guiaccent1 = "#cb4b16"
  let s:guiaccent2 = "#111111"
  let s:guiaccent3 = "#aaaaaa"
  let s:guiaccent4 = "#2aa198"
  let s:guiaccent5 = "#111111"
  let s:guiaccent6 = "#6c71c4"
  let s:guiaccent7 = "#111111"
  ...
  exec "hi Type guifg=".s:guiaccent0
  exec "hi Type ctermfg=".s:ctermaccent0
  ...
  exec "hi NonText guifg=".s:guishade0." guibg=".s:guishade0
  exec "hi NonText ctermfg=".s:ctermshade0." ctermbg=".s:ctermshade0
