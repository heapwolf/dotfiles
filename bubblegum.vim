...
let s:WI = [ '#ffffff', '#5f0000', 231, 124 ]
let g:airline#themes#bubblegum#palette.normal.airline_warning = [
     \ s:WI[0], s:WI[1], s:WI[2], s:WI[3]
     \ ]

let g:airline#themes#bubblegum#palette.normal_modified.airline_warning =
    \ g:airline#themes#bubblegum#palette.normal.airline_warning

let g:airline#themes#bubblegum#palette.insert.airline_warning =
    \ g:airline#themes#bubblegum#palette.normal.airline_warning

let g:airline#themes#bubblegum#palette.insert_modified.airline_warning =
    \ g:airline#themes#bubblegum#palette.normal.airline_warning

let g:airline#themes#bubblegum#palette.visual.airline_warning =
    \ g:airline#themes#bubblegum#palette.normal.airline_warning

let g:airline#themes#bubblegum#palette.visual_modified.airline_warning =
    \ g:airline#themes#bubblegum#palette.normal.airline_warning

let g:airline#themes#bubblegum#palette.replace.airline_warning =
    \ g:airline#themes#bubblegum#palette.normal.airline_warning

let g:airline#themes#bubblegum#palette.replace_modified.airline_warning =
    \ g:airline#themes#bubblegum#palette.normal.airline_warning
