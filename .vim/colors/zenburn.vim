...
if exists("g:zenburn_high_Contrast") && g:zenburn_high_Contrast
    ...
    if &t_Co > 255
        ...
        hi TabLineFill   ctermbg=236 ctermfg=black
    endif
else
    ...
    if &t_Co > 255
        ...
        hi TabLine       ctermbg=235 ctermfg=white cterm=none
        hi TabLineSel    ctermbg=237 ctermfg=white cterm=bold
        hi TabLineFill   ctermbg=233 ctermfg=235
